...
for i in range(100):
    ...
    bert.append(bertscore.compute(predictions=[predictions_truncated[i]],references=[target[i]],lang="bn"))

print('Writing to File')

with open('/Users/vareeshbainwala/Documents/Coursework/Codes/COMS6998/Summarization/Experiment_Results/bloomz_summ_bn.csv','w') as file:
