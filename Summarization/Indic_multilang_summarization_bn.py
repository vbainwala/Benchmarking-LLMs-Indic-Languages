...
# START: COPIED FROM https://github.com/anoopkunchukuttan/indic_nlp_library/tree/master
# The path to the local git repo for Indic NLP library
INDIC_NLP_LIB_HOME=r"/Users/vareeshbainwala/Downloads/indic_nlp_library"

# The path to the local git repo for Indic NLP Resources
INDIC_NLP_RESOURCES=r"/Users/vareeshbainwala/Downloads/indic_nlp_resources"
...
loader.load()
# END: COPIED FROM https://github.com/anoopkunchukuttan/indic_nlp_library/tree/master
...
rouge_score = []
for i in range(100):
    # START: COPIED FROM https://huggingface.co/ai4bharat/MultiIndicSentenceSummarization SOME PORTION is Refactored to suit the needs of the given task
    ...
    inp = tokenizer(str(source[i]) + "</s><2bn>", add_special_tokens=False, return_tensors="pt", padding=True).input_ids 
    # For generation. Pardon the messiness. Note the decoder_start_token_id.
    model_output=model.generate(inp, use_cache=True,no_repeat_ngram_size=3, num_beams=4, length_penalty=0.6, early_stopping=True, pad_token_id=pad_id, bos_token_id=bos_id, eos_token_id=eos_id, decoder_start_token_id=tokenizer._convert_token_to_id_with_added_voc("<2bn>"))
    # Decode to get output strings
    decoded_output=tokenizer.decode(model_output[0], skip_special_tokens=True, clean_up_tokenization_spaces=False)
    # print()
    # END: COPIED FROM https://huggingface.co/ai4bharat/MultiIndicSentenceSummarization 
    predictions.append(UnicodeIndicTransliterator.transliterate(decoded_output,"hi","bn"))
...
# print(rouge_score) # जम्मू एवं कश्मीरः अनंतनाग में सुरक्षाबलों के साथ मुठभेड़ में दो आतंकवादी ढेर
...
with open('/Users/vareeshbainwala/Documents/Coursework/Codes/COMS6998/Summarization/Experiment_Results/results_indicbartsummarisation_bn.csv','w') as f: 
